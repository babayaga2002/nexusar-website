...
declare const PopupButton: ({ id, children, as, style, className, buttonProps, ...props }: import("../../embed/types/base").BaseOptions & import("../../embed/types/base").UrlOptions & import("../../embed/types/base").ActionableOptions & import("../../embed/types/base").BehavioralOptions & import("../../embed/types/base").WidthOption & {
...
declare const SliderButton: ({ id, children, as, style, className, buttonProps, ...props }: import("../../embed/types/base").BaseOptions & import("../../embed/types/base").UrlOptions & import("../../embed/types/base").ActionableOptions & import("../../embed/types/base").BehavioralOptions & import("../../embed/types/base").WidthOption & {
